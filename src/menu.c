...
void menu() //Funções do menu
{
    ...
    gotoxy(1,20);
    draw_FULL_dino(); //NAO PRECISA SER DESENHADO LINHA POR LINHA POIS ESTÁ NA PRIMEIRA COLUNA (1,y)
    ...
    case '1':
        ...
        printf("SCORE : ");
        gotoxy(1,29);
        for(j=0; j<87; j++) //DESENHA A MARGEM DO CHÃO
        {
            printf("_");
        }
...
void retorna_menu() //FUNÇÃO RETORNAR PARA O MENU
{
    char tecla;
    do
    {   system("cls");
